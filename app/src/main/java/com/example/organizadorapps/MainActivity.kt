...
class MainActivity : FragmentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val bottomNavigation = BottomNavigationView(this).apply {
            ...
            menu.add(0, 2, 1, "Categorías").setIcon(android.R.drawable.ic_menu_sort_by_size)
            menu.add(0, 3, 2, "Favoritos").setIcon(android.R.drawable.star_big_on)
            menu.add(0, 4, 3, "Uso").setIcon(android.R.drawable.ic_menu_recent_history)
